...
export default function Navbar () {
    return (
        <Box bg={'purple.primary'} position='fixed' top={0} zIndex={100} w={'100%'}> 
            ...
            <HStack gap={6}>
                ...
                <Link href="#token" _hover={{textDecoration: 'none'}}>Token</Link>
                <Link href='#gameplay' _hover={{textDecoration: 'none'}}>Gameplay</Link>
                <Link href={'#roadmap'}  _hover={{textDecoration: 'none'}}>Roadmap</Link>
            </HStack>
             <HStack gap={6}>
                <Button variant={'outline'} borderColor='#fff' _hover={{bg: 'purple.primary'}}>
                    Whitepaper
                </Button>
                <HStack gap={2}>
