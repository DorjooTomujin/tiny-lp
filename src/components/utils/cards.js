...
export const ButtonCard = () => {
    return (
        <ChakraBox whileInView={{opacity: 1, scale: 1, }} initial={{opacity: 0, scale: 0.6}} transition={{type: "spring", duration: 0.8}} viewport={{once: true}} border={'1px #C5C5C5 solid'} pb={20} pt={12} px={24} borderRadius={30} mx="auto" maxW={'1000px'} w={'full'} pos='relative'>
            <Heading textAlign={'center'} w={'70%'} mx='auto' fontWeight={700} fontSize={'32px'}>Play a battle game to learn.
            </Heading>
            <Heading w={'70%'} mx='auto' textAlign={'center'} mb={8} fontWeight={700} fontSize={'32px'}>
                Earn real life and virtual rewards for learning.</Heading>
            <Text textAlign={'center'} w={'70%'} mx='auto'>You can play TinyBattle, fight monsters in many disciplines, win and be rewarded with cryptocurrency.</Text>
...
export const DefaultCard = ({heading, text, icon}) => {
    return (
        <ChakraBox whileInView={{opacity: 1, scale: 1, }} initial={{opacity: 0, scale: 0.6}} transition={{type: "spring", duration: 0.8}} viewport={{once: true}} border={'1px #C5C5C5 solid'} pb={12} pt={20} px={24} borderRadius={30} mx="auto" maxW={'1000px'}  w={'1000px'} pos='relative'>
...
export const BoxCard = ({}) => {
    return (
        <ChakraBox whileInView={{opacity: 1, scale: 1, }} initial={{opacity: 0, scale: 0.6}} transition={{type: "spring", duration: 0.8}} viewport={{once: true}} display={'flex'} alignItems='center' border={'1px #C5C5C5 solid'}  px={12} borderRadius={30} mx="auto" maxW={'1000px'}  w={'1000px'} pos='relative' gap={20}>
            <Box flex={1}>
                <HStack justifyContent={'space-between'}>
                    <Text>Powered by:</Text>
                    <Image src="/assets/img/elf-logo.svg"/>
                </HStack>
